...
public class GameRepository {
    ...
    public Map<String, Object> getGameDetailsWithStats(Integer gameId) {
        String sql = "SELECT " +
                    "g.game_id, g.title, g.description, g.release_date, g.developer, " +
                    "g.publisher, g.cover_image_url, g.total_achievements, " +
                    "g.avg_completion_time_hours, g.metacritic_score, " +
                    "COUNT(DISTINCT ug.user_id) as total_players, " +
                    "AVG(ug.completion_percentage) as avg_completion_rate, " +
